...
CVehModelDataConstant::CVehModelDataConstant(CVehicleClassification_sp pVC, CLaneFlowComposition lfc, CPyConfigData& pyConfig)
	: CVehicleModelData(eVM_Constant, pVC, lfc, 1) // MAGIC NUMBER - truck class count
	, m_pNominalVehicle(nullptr), m_CoV_AS(0.0), m_CoV_AW(0.0)
{
    CConfigData::get().Read.CONSTANT_FILE = pyConfig.Read_CONSTANT_FILE;
    makeNominalVehicle();
	ReadDataIn();    
}
