...
void CAxleWeight23::Add2AxleData(std::vector<CMultiModalNormal> vAxle)
{
	m_v2AxleData = vAxle;
}

void CAxleWeight23::Add3AxleData(std::vector<CMultiModalNormal> vAxle)
{
	m_v3AxleData = vAxle;
}


CMultiModalNormal CAxleWeight23::GetAxleDist(int iTruck, int iAxle)
{
