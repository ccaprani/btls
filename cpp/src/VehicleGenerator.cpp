...
void CVehicleGenerator::setModelHasCars(bool modelHasCars)
{
	m_bModelHasCars = modelHasCars;
}

void CVehicleGenerator::setCarPercent(vec carPercent)
{
	m_vCarPercent = carPercent;
}
