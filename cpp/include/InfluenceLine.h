...
public:
	 ...
	 * ordinates (or applies them via @ref setWeight) so that the IL remains
	 * the single source of bridge-specific physics. The C++ dispatch below
	 * only selects the per-axle force proxy:
	 *
