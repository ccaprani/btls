...
def test_run():
    ...
    config.veh_gen_nominal(lanes_file="./LanFlowData_OneLane.csv", nominal_file="./nominal_vehicle.csv", no_days=1, lane_eccentricity_std=0.0, kernel_type=0)
    ...
    config.flow_gen_constant(vehicle_classification=1, constant_speed=36, constant_gap=86400)
