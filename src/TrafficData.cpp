...
CTriModalNormal CTrafficData::GetSpacingDist(std::size_t iTruck, std::size_t iSpace)
{
	switch( iTruck )
	{
		case 2:
...
CTriModalNormal CTrafficData::GetAxleWeightDist(std::size_t iTruck, std::size_t iAxle)
{
	if( iTruck == 2 )
...
CTriModalNormal	CTrafficData::GetTrackWidthDist(std::size_t iTruck, std::size_t iAxle)
{
	switch( iTruck )
	{
		case 2:
...
std::vector<double> CTrafficData::GetGVWRange(std::size_t iTruck, std::size_t iRange)
{
...
CTriModalNormal CTrafficData::GetGVW(std::size_t dir, std::size_t iTruck)
{
	if(dir == 1)
...
CTriModalNormal CTrafficData::GetSpeed(std::size_t dir)
{
	if (dir == 1)
		return m_vSpeed[0];
	else
...
void CTrafficData::Add45AxleWeight(std::vector<double> data, std::size_t iTruck, std::size_t iRange)
{
	GVWRange range;
