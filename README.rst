...
On Linux, the prebuilt wheel also needs glibc 2.28 or newer (Ubuntu 20.04+, Debian 10+, RHEL 8+); on older systems pip builds from source instead, which needs GCC 9 or newer.
Then, just do:
