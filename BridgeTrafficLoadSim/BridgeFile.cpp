...
// Up to version 1.1.0
/*
double CBridgeFile::ReadLoadEffect(CBridge* pBridge, vector<CInfluenceLine> vDiscreteIL, std::vector<CInfluenceLine> vInfSurf)
{
	string line;
	m_CSV.getline(line);
...
vector<CBridge*> CBridgeFile::getBridges()
{
	return m_vpBridge;
}
