...
* **Load-effect mode:** vertical and centrifugal (``W·v²/g``, unsigned) — the
  same per-axle force coefficient the C++ engine applies. Centrifugal is
  experimental: see :doc:`theory`.
